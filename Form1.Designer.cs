namespace CMSWinFormsApp1
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1.Location = new Point(126, 173);
            label1.Name = "label1";
            ...
            menuStrip1.Items.AddRange(new ToolStripItem[] { wToolStripMenuItem, customerToolStripMenuItem, jobDetailsToolStripMenuItem, reportsToolStripMenuItem, exitToolStripMenuItem });
            ...
            wToolStripMenuItem.ShortcutKeys = Keys.Alt | Keys.W;
            wToolStripMenuItem.Size = new Size(87, 24);
            wToolStripMenuItem.Text = " &Workwe";
            wToolStripMenuItem.Click += wToolStripMenuItem_Click;
            // 
